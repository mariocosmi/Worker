...
namespace Solari.Core
{
	...
	public class Crypto {
		...
		private bool mCompactCompatible = false; // cripta in modalità compatibile con i terminalini
		#endregion
		...
		public static string FastMicroDecrypt(string src) {
			try {
				Crypto c = new Crypto(CryptoTypes.encTypeTripleDES, true);
