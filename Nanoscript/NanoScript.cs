...
namespace NanoScript
{
    ...
    {        
        ...
        {           
            ...
            referencedAssemblies["System.dll"] = "System.dll";
            referencedAssemblies["mscorlib.dll"] = "mscorlib.dll";
            referencedAssemblies["System.Data.dll"] = "System.Data.dll";                      
        }
        ...
        public void Compile()
        {
            ...
            parameters.ReferencedAssemblies.Add("NanoScript.dll");
            ...
            if (results.Errors.Count > 0)
            {
                ...
                throw new ScriptingContextException("Compiling errors", errors);
            }
